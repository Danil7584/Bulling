...
define gui.dialogue_width = 1509
...
define gui.choice_button_width = 250
define gui.choice_button_height = None
define gui.choice_button_tile = False
define gui.choice_button_borders = Borders(10, 19, 10, 19)
...
init python:
    ...
    if renpy.variant("small"):
        ...
        gui.dialogue_width = 498

        ## Изменяет размеры и интервалы различных объектов.
        gui.slider_size = 36

        gui.choice_button_width = 240
